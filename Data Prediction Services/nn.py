...
@app.route('/regression_nn', methods = ['GET','POST'])
def regression_nn():
   ...
   def model_predict():
      ...
      best_model.save('template/best_regression_model.h5')
      return render_template('regression_nn.html', model=best_model.summary(), score=best_loss)
   
   return model_predict()

@app.route('/classification_nn', methods = ['GET','POST'])
def classification_nn():
   ...
   def model_predict():
      ...
      best_model.save('template/best_classification_model.h5')
      return render_template('classification_nn.html', model=best_model.summary(), score=best_loss)
